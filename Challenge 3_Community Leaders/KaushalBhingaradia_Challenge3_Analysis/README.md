...
\- `DataKind\_Challenge\_3\_Identifying\_Community\_Leaders.html` – Full Jupyter Notebook export  

\- `community\_leaders.csv` – Final leaderboard with composite leader scores  (removed as it is a very large file)

\- `community\_leaders\_analysis.png` – 4 visualizations from the analysis for top leaders, reach, topic specialization, and network distribution.

\- `community\_network.png` – 4 visualization of the user network distribution.
